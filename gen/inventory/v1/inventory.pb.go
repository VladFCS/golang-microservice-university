...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\breserved\x18\x03 \x01(\x03R\breserved\"0\n" +
	"\x0fGetStockRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\"=\n" +
	"\x10GetStockResponse\x12)\n" +
	"\x05stock\x18\x01 \x01(\v2\x13.inventory.v1.StockR\x05stock\"P\n" +
	"\x13ReserveStockRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x03R\bquantity\"A\n" +
	"\x14ReserveStockResponse\x12)\n" +
	"\x05stock\x18\x01 \x01(\v2\x13.inventory.v1.StockR\x05stock2\xb4\x01\n" +
	"\x10InventoryService\x12I\n" +
	"\bGetStock\x12\x1d.inventory.v1.GetStockRequest\x1a\x1e.inventory.v1.GetStockResponse\x12U\n" +
	"\fReserveStock\x12!.inventory.v1.ReserveStockRequest\x1a\".inventory.v1.ReserveStockResponseBLZJgithub.com/vlad/microservices-grpc-kubernetes/gen/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0, // 1: inventory.v1.ReserveStockResponse.stock:type_name -> inventory.v1.Stock
	...
	4, // 5: inventory.v1.InventoryService.ReserveStock:output_type -> inventory.v1.ReserveStockResponse
